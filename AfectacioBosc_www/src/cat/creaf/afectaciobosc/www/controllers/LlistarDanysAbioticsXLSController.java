 ...
 * @author a_escobar
 */
public class LlistarDanysAbioticsXLSController extends LlistarXLSController {

    private IAfectacioService afectacioService;

    public LlistarDanysAbioticsXLSController() {
        super(new TransformadorDanyAbioticXLS());
    }
...
//        int total = afectacioService.getSequeresCount();
        ...
        crearXLS(afectacioService.getDanysAbiotics(
            ordenacio,dir,
