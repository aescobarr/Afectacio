    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            <c:if test="${dades.esborrable}">esborrable = true;</c:if>
                ...
                var urlElementsTaulaJSON = "http://" + urlServidor + "<c:url value='/danysmecanics/llistardanysmecanicsjson.htm?'/>";
        ...
        <script type="text/javascript" src="<c:url value='/js/DanysMecanics/llistarDanysMecanics.js' />"></script>
        ...
        <script type="text/javascript">
          ...
          /*  var tiledAnterior = crearCapaUsuariAnterior();*/
            ...
            taula['DANYMECANIC_GEOMETRIA'] = new Array(2);
            taula['DANYMECANIC_GEOMETRIA'][0] = new Array(2);
            taula['DANYMECANIC_GEOMETRIA'][0][0] = "visualitzar";
            taula['DANYMECANIC_GEOMETRIA'][0][1] = Array(1);
            taula['DANYMECANIC_GEOMETRIA'][0][1][0] = 0;
            taula['DANYMECANIC_GEOMETRIA'][1] = new Array(1);
            taula['DANYMECANIC_GEOMETRIA'][1][0] = new Array(2);
            taula['DANYMECANIC_GEOMETRIA'][1][0][0] = 1;
            taula['DANYMECANIC_GEOMETRIA'][1][0][1] = "<fmt:message key='codi' bundle='${bundleAfectacio}' />";

      /*      taula['DANYMECANIC_ANTERIOR_GEOMETRIA'] = new Array(2);
            taula['DANYMECANIC_ANTERIOR_GEOMETRIA'][0] = new Array(2);
            taula['DANYMECANIC_ANTERIOR_GEOMETRIA'][0][0] = "visualitzar";
            taula['DANYMECANIC_ANTERIOR_GEOMETRIA'][0][1] = Array(1);
            taula['DANYMECANIC_ANTERIOR_GEOMETRIA'][0][1][0] = 0;
            taula['DANYMECANIC_ANTERIOR_GEOMETRIA'][1] = new Array(1);
            taula['DANYMECANIC_ANTERIOR_GEOMETRIA'][1][0] = new Array(2);
            taula['DANYMECANIC_ANTERIOR_GEOMETRIA'][1][0][0] = 1;
            taula['DANYMECANIC_ANTERIOR_GEOMETRIA'][1][0][1] = "<fmt:message key='codi' bundle='${bundleAfectacio}' />";
*/
            ...
            function crearCapaUsuari(){
                ...
                {
                    layers: 'SIPAN:DANYMECANIC_GEOMETRIA',
                    styles: '',
                    transparent: 'true',
                    format: 'image/png',
                    width: '800',
       ...
       /*     function crearCapaUsuariAnterior(){
                ...
                "http://"+ urlServidor + "/geoserver/wms",
                {
                    layers: 'SIPAN:DANYMECANIC_ANTERIOR_GEOMETRIA',
                    styles: '',
                    transparent: 'true',
                    format: 'image/png',
                    width: '800',
...
*/
            function crearCapaPEIN(){
                var capa = new OpenLayers.Layer.WMS(
                    "PEIN","http://"+urlServidor+"/geoserver/wms",
                    {
            ...
            function nou(){
                document.dades.action = "<c:url value='/danysmecanics/edicio/inserir.htm'/>";
                document.dades.submit();
            }

            function enrera(){
                document.dades.action = "<c:url value='/danysmecanics/llistardanysmecanics.htm'/>";
                document.dades.submit();
            }
            ...
            function acceptarISortir(){
                if(validaDades()){
                    getDadesEstimacions();
                    document.dades2.action = "<c:url value='/danysmecanics/edicio/editar.htm'/>";
                    document.dades2.novaurl.value = "/danysmecanics/llistardanysmecanics.htm";
            ...
            function acceptar(){
                if(validaDades()){
                    getDadesEstimacions();
                    document.dades2.action = "<c:url value='/danysmecanics/edicio/editar.htm'/>";
                    document.dades2.novaurl.value = "/danysmecanics/edicio/editar.htm";
                    document.dades2.wkt.value=getWKTDeObjectesDigitalitzats();
                    document.dades2.submit();
                }
            }
            ...
            function visualitzar(id){
                window.open("<c:url value='/danysmecanics/imprimirdanysmecanics.htm'/>?idafectacio="+id,'popup','width=970,height=550,scrollbars=YES,resizable=YES,left=0');
            }

            function editar(id){
                document.dades.idafectacio.value = id;
                document.dades.action = "<c:url value='/danysmecanics/edicio/editar.htm'/>?";
                document.dades.submit();
            }
            ...
            function esborrar(id){
                if(confirm("<fmt:message key='confirmacio' bundle='${bundleSIPAN}' />")){
                    document.dades.idafectacio.value = id;
                    document.dades.novaurl.value = "/danysmecanics/llistardanysmecanics.htm";
                    document.dades.action = "<c:url value='/danysmecanics/edicio/esborrar.htm'/>?";
                    document.dades.submit();
                }
            }
            ...
            function descarregarFitxer(){
                if(confirm("<fmt:message key='confirmacioTrigaMinuts' bundle='${bundleSIPAN}' />")){
                    var url = "<c:url value='/danysmecanics/llistardanysmecanicsxls.htm'/>";
                    window.open(url);
                }
            }
         ...
         /*       var capa = readCookie('danysmecanics');
                tiled.setVisibility(capa=='true');
                capa = readCookie('danysmecanicsanterior');
            ...
            /*    document.cookie = "danysmecanics="+tiled.visibility+"; path=/";
                document.cookie = "danysmecanicsanterior="+tiledAnterior.visibility+"; path=/";*/
            }
        ...
        <%
                    ...
                    cat.creaf.afectaciobosc.model.DanyMecanic afectacio = ((cat.creaf.afectaciobosc.model.DanyMecanic) request.getAttribute("afectacio"));
                    if (afectacio != null
        ...
        <div id="doc" class="yui-d2">
            ...
            <div id="bd">
                <div class="modul mdanymecanic">
                    ...
                    <a href="#" onclick="javascript:obrirpopup('<c:url value='/grafics/ajuda_danysmecanics.pdf'/>');return false;" title="<fmt:message key='protocol' bundle='${bundleAfectacio}' />"><fmt:message key='protocol' bundle='${bundleAfectacio}' /></a>&nbsp;
                    <a href="#" onclick="javascript:obrirpopup('<c:url value='/grafics/fitxa_camp_danysmecanics.pdf'/>');return false;" title="<fmt:message key="fitxaNevadesCampPDF" bundle="${bundleAfectacio}" />"><fmt:message key="fitxaNevadesCampPDF" bundle="${bundleAfectacio}" /></a>
                    <div class="eina">
                        <div class="continguteina">
                            <c:if test="${dades.llistableShape}">
                            <div class="eines_fitxa">
                                <a class="veure_shape" href="http://${dades.ip}/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SIPAN:DANYMECANIC_GEOMETRIA&outputFormat=SHAPE-ZIP"   title="<fmt:message key="exportarShape" bundle="${bundleSIPAN}" />">&nbsp;</a>
                            </div>
                            </c:if>
                            <% if (esEditable) {%>
                            <div id="fitxa">
                                <form name="dades2" method="POST" action="">
                                    <spring:nestedPath path="afectacio">
                                        <div class="yui-content mdanymecanic">
                                            <%@ include file="/WEB-INF/jsp/DanysMecanics/pestanyaDadesBasiques.jsp" %>
                                        </div>
