 ...
 */
@Deprecated
public class LlistarDanysMecanicsController extends AbstractController {

//    private IAfectacioService afectacioService;
//
//    public LlistarDanysMecanicsController(){
//        super();
//    }
...
//            llistableShape = llistableShape || "ROLE_CONSULTA_SHAPE_DANYMECANIC".equals(usuari.getAuthorities().get(i).getAuthority());
//        }
//        hm.put("editable", editable);
//        hm.put("esborrable", esborrable);
//        hm.put("llistableShape", llistableShape);
//        return new ModelAndView("DanysMecanics/llistarDanysMecanics", "dades", hm);
        return null;
    }
