...
<html xml:lang="ca" lang="ca" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="layoutcentral blockinfo">
            ...
            <p><fmt:message key="excepcioBD" bundle="${bundleSIPAN}"/></p>
            <ul>
                <li><fmt:message key="excepcioBDRegistreUsat" bundle="${bundleSIPAN}"/></li>
            </ul>
            <p><fmt:message key="excepcioContactar" bundle="${bundleSIPAN}"/></p>
        </div>
    </body>
